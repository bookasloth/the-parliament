...
export function UpgradePrompt({
  ...
  if (compact) {
    return (
      <Link
        href="/membership"
        className="inline-flex items-center gap-1 rounded-full bg-brand-50 px-2.5 py-1 text-xs font-semibold text-brand hover:bg-brand-100"
      >
  ...
  return (
    <div className="flex flex-col items-center gap-3 rounded-xl border border-dashed border-gray-300 bg-gray-50 px-6 py-8 text-center">
      ...
      <Link
        href="/membership"
        className="inline-flex items-center gap-1.5 rounded-lg bg-brand px-5 py-2 text-sm font-semibold text-white hover:bg-brand-600"
      >
