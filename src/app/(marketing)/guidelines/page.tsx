...
import { ShieldCheck, Check, X, AlertTriangle, Ban } from "lucide-react"
import { Section, Eyebrow, Reveal } from "@/components/marketing/primitives"

export const metadata: Metadata = {
  title: "Community Rules & Guidelines — NNAWCA",
  description:
    "The rules and expectations for everyone on the NNAWCA platform — a safe, respectful, high-signal space for Navodayans to connect, contribute and grow.",
}
