  ...
  return (
    <div className="mx-auto max-w-[1400px] px-4 sm:px-6 py-6">
      <div className="mb-6 flex items-center justify-between">
        ...
        {canList && (
          <Link href="/business/new" className="flex items-center gap-1.5 rounded-[4px] bg-brand px-4 py-2 text-sm font-semibold text-white hover:bg-brand-600">
      ...
      {businesses.length === 0 ? (
        <div className="rounded-[5px] border border-gray-200 bg-white p-12 text-center text-sm text-gray-500">
            ...
            <Link key={b.id} href={`/business/${b.slug}`} className="rounded-[5px] border border-gray-200 bg-white p-5 transition-shadow hover:shadow-md">
              <div className="flex items-center gap-3">
                {b.logoUrl ? (
                  ...
                  <div className="flex h-12 w-12 items-center justify-center rounded-[4px] bg-brand-50 text-brand"><Building2 className="h-6 w-6" /></div>
                )}
