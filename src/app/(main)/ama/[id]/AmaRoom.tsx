...
export default function AmaRoom({
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 sm:px-6 py-10">
      <div className="rounded-[5px] border border-gray-200 bg-white p-6 text-center">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-[5px] bg-brand/10 text-brand">
        ...
        <p className="mt-4 inline-flex items-center gap-1.5 rounded-[3px] bg-gray-100 px-3 py-1 text-xs text-gray-600">
        ...
        <button
          onClick={join}
          disabled={busy}
          className="mt-6 w-full rounded-[5px] bg-brand py-2.5 text-sm font-semibold text-white hover:bg-brand-600 disabled:opacity-50"
        >
