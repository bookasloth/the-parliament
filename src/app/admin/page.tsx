  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 mb-5">
        <StatCard label="Total Users" value="2,847" delta="+4.7%" deltaUp icon={<Users className="h-4.5 w-4.5" />} accent="indigo" />
        <StatCard label="Active Today" value="612" delta="+12.3%" deltaUp icon={<Activity className="h-4.5 w-4.5" />} accent="emerald" />
        <StatCard label="Pending Verifications" value="12" delta="+5" deltaUp={false} icon={<ShieldCheck className="h-4.5 w-4.5" />} accent="amber" />
