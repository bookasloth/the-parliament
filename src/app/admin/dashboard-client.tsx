  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <div className="flex rounded-[4px] border border-zinc-800 bg-[#111113] p-0.5">
            {(["7d", "30d", "12m"] as const).map(r => (
              <button key={r} onClick={() => setRange(r)}
                className={`rounded-[3px] px-3 py-1.5 text-xs font-semibold transition-colors ${range === r ? "bg-blue-600 text-white" : "text-zinc-400 hover:text-zinc-200"}`}>
                {r}
              </button>
            ))}
          </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-5">
        ...
        <div className="rounded-[4px] border border-zinc-800 bg-[#111113] p-4 sm:p-5">
          ...
          <div className="mt-4 rounded-[4px] bg-zinc-900 border border-zinc-800 p-3">
